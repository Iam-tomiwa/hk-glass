...
function EditOrderForm() {
  ...
  useEffect(() => {
    ...
    form.reset({
      ...
      glassInventorySerialCodes: Array.isArray(raw.glass_inventory_serial_codes)
        ? (raw.glass_inventory_serial_codes as string[])
        : raw.glass_inventory_serial_codes
          ? [(raw.glass_inventory_serial_codes as string)]
          : [],
    });
